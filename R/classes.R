...
#'
#' @slot metadata Any metadata such as datetime, species ID, etc.
#' @slot data Any calculations such as residence time estimation.
#' @slot timestamp Timestamp of object generation.
#'
#' @details
#' words
#'
