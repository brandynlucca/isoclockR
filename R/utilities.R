...
#' Method for what is printed for ISO object summaries.
#' @export
...
#' Method for what is printed for MISO object summaries.
#' @export
setMethod("summary", "ISO", function(object) {
  cat(paste(class(object)[[1]], " object", sep=""),
      "\n", "Number of ISO objects: ", (length(object)), "\n",
      "Isotopes measured: ", unique(names(object@data[[1]])), "\n",
      paste("Mean ", unique(names(object@data[[1]])),": ", sep=""))
})
